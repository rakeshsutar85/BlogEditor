package com.rakeshsutar.blogeditor;
...
public class BlogEditor extends WebView {
    ...
    public BlogEditor(Context context) {
        this(context, null);
    }

    public BlogEditor(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.webViewStyle);
    }

    @SuppressLint("SetJavaScriptEnabled")
    public BlogEditor(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    /**
     * {@link BlogEditor#insertImage(String, String)} will show the original size of the image.
